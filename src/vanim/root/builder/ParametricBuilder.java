...
public class ParametricBuilder extends VObjectBuilder {
    ...
    public ParametricBuilder(GeometricSpace p, FVector boundX, UnivariateFunction xt, UnivariateFunction yt, int speed, Color color, Reason reasonCreated) {
    ...
    public ParametricBuilder(Grid p, UnivariateFunction xt, UnivariateFunction yt, int speed, Color color, Reason reasonCreated) {
        this(p, new FVector(p.getAxes()).scale(-2f), xt, yt, speed, color, reasonCreated);
    }

    public ParametricBuilder(Grid p, UnivariateFunction xt, UnivariateFunction yt, int speed, Color color) {
