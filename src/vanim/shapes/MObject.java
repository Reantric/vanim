...
public abstract class MObject {
    ...
    public MObject(PApplet p,PGraphics c, float x, float y, float w, float h, float colHue,float colSat, float colBright){
        //println("IS NULL? " + p);
        processing = p;
        canvas = c;
        pos = new PVector(x,y);
    ...
    public MObject(PGraphics c, float x, float y, float colHue, float colSat, float colBright){
        this(null,c,x,y,0,0,colHue,colSat, colBright);
    }

    public MObject(PApplet p,PGraphics c,float x, float y,float s, float colHue, float colSat, float colBright) {
        this(null,c,x,y,s,s,colHue,colSat,colBright);
    }

    public MObject(PApplet p, PGraphics c, float x, float y, float w, float h) {
        this(p,c,x,y,w,h,0,0,0);
    }

    public MObject(PGraphics c, float x, float y, float radius, int colHue, int colSat, int colBright) {
